/*
aqui va el filtro de proveedores con formato XML
*/
...
let proveedor_xml = require('../configuraciones/datos_proveedores'); // importa todos los proveedores de todos los paises
